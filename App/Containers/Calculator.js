...
import CardboardImage from '../../assets/images/cardboards.png';
...
class Calculator extends NavigatorComponent {
  ...
  constructor(props) {
    ...
    this.openShippingFeeReference = this.openShippingFeeReference.bind(this);
    this.calculateButtonClicked = this.calculateButtonClicked.bind(this);
  }
  ...
  openShippingFeeReference() {
    this.pushToNextComponent(
      WebInspector,
      { title: '運費寄量表', uri: `${DOMAIN}/shipping_fees` },
        ...
        <View style={MiumiuTheme.container}>
          ...
          <View style={styles.body}>
            ...
            <View style={styles.guide}>
              <Image source={CardboardImage} />
              <Text style={{ ...MiumiuTheme.contentText, ...styles.guideLabel }}>貨品測量參考基準</Text>
              <TouchableOpacity onPress={this.openShippingFeeReference}>
                <Text style={{ ...MiumiuTheme.contentText, ...styles.guideLinkLabel }}>
                  您還可以參考完整的運費寄量表
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : null}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.calculateButtonClicked}
              >
                <Text
                  style={{
