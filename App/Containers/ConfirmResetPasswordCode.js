...
class ConfirmResetPasswordCode extends NavigatorComponent {
  ...
  componentWillReceiveProps(props) {
    ...
    const { resendResetPasswordConfirmCode: _resendResetPasswordConfirmCode, confirmState: _confirmState } = this.props;
    const { password } = this.state;
    if (
      (_resendResetPasswordConfirmCode.isRequesting !== resendResetPasswordConfirmCode.isRequesting) &&
      ...
      if (resendResetPasswordConfirmCode.error) {
        ...
        resendResetPasswordConfirmCode.timestamp &&
        this.state.timestamp !== resendResetPasswordConfirmCode.timestamp
      ) {
  ...
  submitConfirmCode() {
    ...
    const { password, passwordConfirmation, codes, isAccountTypeEmail } = this.state;
  ...
  render() {
    const { confirmState, resendResetPasswordConfirmCode } = this.props;
